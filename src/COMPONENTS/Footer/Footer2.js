    ...
    <div className='footer'>
      <div className='footerin1'>
        <div className='f1'>
          ...
          <p>GrocerGo is a leading online grocery store in the India. We are committed to providing the best quality products at the best prices.</p>
      ...
      <div className='footerin2'>
        <h3>© Copyright 2024 GrocerGo, Inc.  All rights reserved</h3>
